...
import Listeners.MyButton;
import Listeners.MyLabel;
...
public class QuestionView extends GridPane implements UiElements, AbstractMainView {
	...
	public void gridPane() {
		...
		gpRoot.add(createMyArrayList(), 0, 21);
		gpRoot.add(newButton.getNewBut(), 0 , 22);
		gpRoot.add(newLabel.getNewLabel(), 1, 22);
		//Exit button
		gpRoot.add(saveAndExitOrReturn(questionScene), 3, 25);
	}
